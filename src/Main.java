...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (opcao) {
                case 1.0:
                    System.out.println("Digite J para Pessoa Jurídica ou F para Pessoa Física");
                    ...
                    if (tipo == 'F' || tipo == 'f') {
                        ...
                        repoFisica.inserir(new PessoaFisica(id, name, cpf, idade));
                    } else if (tipo == 'J' || tipo == 'j') {
                        System.out.print("CNPJ: ");
                        String cnpj = sc.nextLine();
                        repoJuridica.inserir(new PessoaJuridica(id, name, cnpj));
                    }
                    break;
                ...
                case 2.0:
                    ...
                    if (tipoAlterar == 'F' || tipoAlterar == 'f') {
                        ...
                        if (pfAtual != null) {
                            ...
                            System.out.print("Name: ");
                            String novoName = sc.nextLine();
                            System.out.print("CPF: ");
                            String novoCpf = sc.nextLine();
                            System.out.print("Idade: ");
                            int novaIdade = sc.nextInt();
                            PessoaFisica pfAlterada = new PessoaFisica(idAlterar, novoName, novoCpf, novaIdade);
                        ...
                        if (pjAtual != null) {
                            ...
                            System.out.println("Insira os novos dados...");
                            System.out.print("Name: ");
                            String novoNameJ = sc.nextLine();
                            System.out.print("CNPJ: ");
                            String novoCnpj = sc.nextLine();
                            PessoaJuridica pjAlterada = new PessoaJuridica(idAlterar, novoNameJ, novoCnpj);
                ...
                case 6.0:
                    ...
                    System.out.println("Digite o prefixo para o name do arquivo: ");
                ...
                case 7.0:
                    ...
                    System.out.println("Digite o prefixo do name do arquivo para recuperar os dados:");
